            ...
            for emp in employees_under_manager:
                ...
                if emp.emp_project == "Indihood" or emp.emp_project == "ONECLICKLCA":
                    ...
                    for dform_entry, quality_entry in joined_matched_employees.all():
                        total_client_esc_value += int(quality_entry.client_esc_value or 0)
                        total_not_writing_testcase_value += int(quality_entry.not_writing_testcase_value or 0)
                        total_invalid_defects_value += int(quality_entry.invalid_defects_value or 0)
                        total_client_req_value += int(quality_entry.client_req_value or 0)
                        total_issue_rej_value += int(quality_entry.issue_rej_value or 0)
                        total_time_man_value += int(quality_entry.time_man_value or 0)
                        total_interaction_value += int(quality_entry.interaction_value or 0)
                        total_test_condn_value += int(quality_entry.test_condn_value or 0)
                        total_gram_incor_value += int(quality_entry.gram_incor_value or 0)
                        total_pre_condn_value += int(quality_entry.pre_condn_value or 0)
                        total_communication_value += int(quality_entry.communication_value or 0)
                        total_app_flow_value += int(quality_entry.app_flow_value or 0)
